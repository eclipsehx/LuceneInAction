...
public class IndexingTest extends TestCase {
	...
	private IndexWriter getWriter() throws IOException {	// 2
		return new IndexWriter(directory, new WhitespaceAnalyzer(), IndexWriter.MaxFieldLength.UNLIMITED);	// 2
	}
	...
	public void testMaxFieldLength() throws IOException {
		...
		IndexWriter writer = new IndexWriter(directory, new WhitespaceAnalyzer(), new IndexWriter.MaxFieldLength(1));	// 2

		Document doc = new Document();	// 3
		doc.add(new Field("contents", "these bridges can't be found", Field.Store.NO, Field.Index.ANALYZED));	// 3
