...
<!--
  #1 If user selects a preference for type of job, apply choice of permanent/contract filter and cache
  #2 Use standard Lucene query parser for any job description input
  #3 If any of the location fields are set OR them ALL in a Boolean filter and cache individual filters
