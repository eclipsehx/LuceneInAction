...
public class BasicSearchingTest extends TestCase {
	...
	public void testTerm() throws Exception {
		...
		assertEquals("Ant in Action", 1, docs.totalHits); 	// C

		t = new Term("subject", "junit");

		docs = searcher.search(new TermQuery(t), 10);
		assertEquals("Ant in Action, " + "JUnit in Action, Second Edition", 2, docs.totalHits); 	// D
	...
	*/
	...
	public void testQueryParser() throws Exception {
		...
		QueryParser parser = new QueryParser(Version.LUCENE_30, "contents", new SimpleAnalyzer());	// A
