...
public class SAXXMLDocument extends DefaultHandler {
	...
	public Document getDocument(InputStream is) throws DocumentHandlerException {	// #1
	...
	@Override
	public void startElement(String uri, String localName, String qName, Attributes atts) throws SAXException {		// #3
