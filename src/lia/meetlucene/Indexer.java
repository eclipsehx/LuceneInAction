...
public class Indexer {
	...
	public static void main(String[] args) throws Exception {
		...
		String dataDir = args[1];  		// 2 Index *.txt files from this directory
	...
	public Indexer(String indexDir) throws IOException {
		...
		writer = new IndexWriter(	// 3 Create Lucene IndexWriter
				dir, 	
		...
		writer.setUseCompoundFile(false);	// 创建多文件索引
	}
	...
	private static class TextFilesFilter implements FileFilter {
		...
		public boolean accept(File path) {
			return path.getName().toLowerCase().endsWith(".txt"); 	// 6 Index .txt files only, using FileFilter
		}
	}
